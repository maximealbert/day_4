...
@app.route('/teams/<string:team_id>/channels', methods=['GET'])
def member_of(team_id):
    headers = {
    ...
    api_url_2 = 'https://graph.microsoft.com/v1.0/teams/'+str(team_id)+'/channels'
    try:
        ...
        for channel in data['value']:
            final_list = final_list + [(channel['displayName'], channel['id'])]
...
if __name__ == '__main__':
    print(member_of('90967af7-d54b-47bf-a911-c802fb4dbc08'))
