...
@app.route('/teams/<string:team_id>/channels/<string:channel_id>/messages', methods=['GET'])
def member_of(team_id, channel_id):
    headers = {
    ...
    api_url = 'https://graph.microsoft.com/beta/teams/' + str(team_id) + '/channels/' + str(channel_id) + '/messages'
    ...
    try:
        ...
        #for channel in data['value']:
            #final_list = final_list + [channel['displayName']]
...
if __name__ == '__main__':
    print(member_of('90967af7-d54b-47bf-a911-c802fb4dbc08', '19:WlSxgjLfsD-6cfnsxXQgYuzfo7bbRANaEgAbV57WbUY1@thread.tacv2'))